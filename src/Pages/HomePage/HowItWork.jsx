            ...
            <section className="w-full flex items-center justify-center px-6 mt-44">
                <div className="w-9/12 mt-40 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex-1">
                        <div className="">
                            <h3 className="text-[#1929D6] text-xl">EASY TO USE</h3>
                        ...
                        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4 mt-2  ">
                            {features.map((feature, index) => (
                                <div key={index} className="flex items-center space-x-3 ">
                                    ...
                                    <p className="text-gray-800 p-[2px] ">{feature.text}</p>
                                </div>
                            ))}
                        </div>
                    </div>

                      <div className="flex w-[580px] relative text-center md:text-left mb-36">
                            <img className="absolute right-32 top-[-160px] h-72" src="./ellipse.png" alt="" />
                        <div className="w-92 ml-32 h-78 bg-[#1929D6]"></div>
                      <div className="">
                          <img
                            src="/phonesgroup.png"
                            alt="Phone"
                            className="absolute top-1/2 left-[350px] transform -translate-x-1/2 -translate-y-1/2 "
                        />
                      </div>
                      <div className="absolute bottom-[-100px] left-32">
